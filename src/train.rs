...
impl TrainPipeline {
    ...
    fn collect_data(&mut self, games: usize, max_length: usize) -> usize {
        let mut threads = vec![];
    ...
    async fn train(&mut self) {
        ...
        loop {
            ...
            {
                let timestamp = self.timestamp.lock().await;
            ...
            let len = self.collect_data(8, 99999);
            println!(
...
fn start_self_play(
    ...
    let mut player = MCTSPlayer::new(net.clone(), c_puct, true, 1);
